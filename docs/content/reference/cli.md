...
```
neuralnetworksdl <command> [arguments] [flags]
```

Run `neuralnetworksdl <command> --help` for the full flag list on any command. This
...
per operation you declare in `neuralnetworksdl/domain.go`.
