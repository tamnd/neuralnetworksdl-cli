...
Most of these come down to network reality or how neuralnetworksdl serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

neuralnetworksdl rate-limits like any public site. neuralnetworksdl already paces
...
Where a surface is gated, neuralnetworksdl reads a cookie or token you supply
...
`neuralnetworksdl`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what neuralnetworksdl actually did
